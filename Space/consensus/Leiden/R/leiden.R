                ...
                install_python_modules <- function(method = "auto", conda = "auto") {
                    if(!is.null(reticulate::conda_binary())){
                        ...
                        if(.Platform$OS.type == "windows"){
                            ...
                            if(!reticulate::py_module_available("umap-learn")) suppressWarnings(suppressMessages(reticulate::conda_install(envname = reticulate.env, packages = "umap-learn", channel = "conda-forge")))
                            ...
                            if(!reticulate::py_module_available("umap-learn")) suppressWarnings(suppressMessages(reticulate::conda_install(reticulate.env, "umap-learn", forge = TRUE)))
                        ...
                        if(!reticulate::py_module_available("umap-learn")) suppressWarnings(suppressMessages(reticulate::py_install("umap-learn")))
