...
sc.pl.embedding(adata, basis="spatial", color="SpaceFlow", s=6, show=False, title='SpaceFlow',save="SpaceFlow_hip.pdf")
...
print('%.5f ---------------------------------------------------------' %ARI)
# adata.obs.to_csv("../results/HIP/domains/spaceflow_9_HIP_%.2f.csv"%ARI)                                 # change
# adata.obs.to_csv("../results/HIP/domains/hip024_spaceflow_{}_hip_{:.2f}.csv".format(seed,ARI))